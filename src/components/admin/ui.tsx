...
export const inputClass =
  "w-full rounded-[10px] border border-border bg-white px-3.5 py-2.5 text-[0.875rem] text-ink transition-colors placeholder:text-text-subtle focus:border-accent focus:outline-none";
...
export function Panel({
  ...
  return (
    <section className={`rounded-[14px] border border-border bg-white p-6 ${className}`}>
      {title && (
...
const buttonBase =
  "inline-flex items-center justify-center gap-2 rounded-[10px] px-4 py-2.5 text-[0.8125rem] font-semibold leading-none transition-all duration-200 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50";
...
export const adminButton = {
  ...
  danger: `${buttonBase} border border-border bg-white text-warning hover:border-warning hover:bg-warning-soft`,
} as const;
...
export function EmptyState({
  ...
  return (
    <div className="rounded-[14px] border border-dashed border-border-strong bg-white p-10 text-center">
