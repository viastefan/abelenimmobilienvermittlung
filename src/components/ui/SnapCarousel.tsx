...
export function SnapCarousel({
  ...
  peekClassName = "px-6 scroll-pl-6 lg:px-10 lg:scroll-pl-10",
  className = "",
}: {
...
function CarouselButton({
  ...
  return (
    <button
      ...
      aria-hidden={hidden}
      tabIndex={hidden ? -1 : 0}
      className={`absolute top-1/2 hidden h-11 w-11 -translate-y-1/2 items-center justify-center rounded-full bg-white/85 text-ink shadow-lift ring-1 ring-border backdrop-blur transition-all duration-300 ease-smooth hover:bg-white lg:flex ${
