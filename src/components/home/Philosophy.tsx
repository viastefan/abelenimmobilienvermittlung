...
export function Philosophy() {
  return (
    <section className="relative overflow-hidden bg-ink-deep py-16 lg:py-24">
      <div
      ...
      <Container className="relative max-w-4xl text-center">
        <Reveal>
          ...
          <blockquote className="mt-7">
            <p className="balance font-display text-xl font-bold leading-snug text-white sm:text-[1.625rem] lg:text-[2rem]">
              „Ich möchte nicht nur Ihre Immobilie vermitteln.
              <br className="hidden sm:block" /> Ich möchte Ihre langfristige Empfehlung sein.“
            </p>
          </blockquote>
          <p className="mt-7 text-label font-bold uppercase text-white/50">{site.owner}</p>
        </Reveal>
      </Container>
    </section>
  );
